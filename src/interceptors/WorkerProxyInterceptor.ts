import { IInterceptor, IMeshPacket, IServiceRegistry } from 'isomorphic-core';
 ...
 */
export class WorkerProxyInterceptor implements IInterceptor<IMeshPacket, IMeshPacket> {
