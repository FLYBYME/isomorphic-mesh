 ...
 */
export class RoutingInterceptor implements IInterceptor<IMeshPacket, IMeshPacket> {
    ...
    async onInbound(packet: IMeshPacket): Promise<IMeshPacket> {
        ...
        if (meta?.finalDestinationID && meta.finalDestinationID !== this.nodeID) {
            ...
            const forwardedPacket: IMeshPacket = {
                ...packet,
                meta: {
                    ...packet.meta,
                    ttl,
            ...
            return { ...packet, topic: '__forwarded', data: undefined };
        }
